  ...
  <div class="row">
    <div class="col-sm-10 offset-sm-1 col-md-8 offset-md-2">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="{{ url('/luckydraws') }}">Lucky Draws</a></li>        
          <li class="breadcrumb-item active" aria-current="page">Create Lucky Draw</li>
        </ol>
      </nav>
      ...
      <div class="card">
        ...
        @endif
          ...
          <form class="needs-validation" novalidate method="POST" action="{{ url('/luckydraws') }}">
            {{ csrf_field() }}
