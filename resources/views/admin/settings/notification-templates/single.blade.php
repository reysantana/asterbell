    ...
    <div class="col-sm-10 offset-sm-1 col-md-8 offset-md-2">
      ...
      <div class="card">
        ...
        @endif
          ...
          <form class="needs-validation" novalidate method="POST" action="{{ url('/settings/notification-templates/'.$template->id) }}">
            {{ csrf_field() }}
            {{ method_field('PUT') }}
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-8 col-md-9">
                <input id="title" type="text" maxlength="255" class="form-control" name="title" value="{{ old('title') ?: $template->title }}" required>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-8 col-md-9">
                <select id="category" class="form-control" name="category" required>
                  <option value="reward" @if (old('category') == 'reward' || $template->category == 'reward') selected="selected" @endif>Reward</option>
                  <option value="message" @if (old('category') == 'message' || $template->category == 'message') selected="selected" @endif>Message</option>
                </select>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-8 col-md-9">
                <input id="excerpt" type="text" maxlength="255" class="form-control" name="excerpt" value="{{ old('excerpt') ?: $template->message_excerpt }}" required>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-8 col-md-9">
                <textarea class="summernote" name="fullMessage">{{ old('fullMessage') ?: $template->message_content }}</textarea>
              </div>
            </div>
