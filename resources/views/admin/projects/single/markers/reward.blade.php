<div class="tab-pane{{ $tab == 'reward' ? ' active' : null }}" id="tab-reward" role="tabpanel">
  <div class="card">
    <div class="card-body">
      ...
      <form class="needs-validation" novalidate enctype="multipart/form-data" method="POST" action="{{ url('/projects/'.$project->slug.'/markers/'.$marker->id.'/reward') }}">
        {{ csrf_field() }}
