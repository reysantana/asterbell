<div class="tab-pane{{ $tab == 'general' ? ' active' : null }}" id="tab-general" role="tabpanel">
  <div class="card">
    <div class="card-body">
      ...
      <form class="needs-validation" novalidate method="POST" action="{{ url('/projects/'.$project->slug.'/projectrewards/'.$reward->id) }}">
        {{ csrf_field() }}
        {{ method_field('PUT') }}
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-8 col-md-9">
            <input id="name" type="text" maxlength="255" class="form-control" name="name" value="{{ old('name') ?: $reward->name }}" required>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-8 col-md-9">
            <input id="markerscan" type="text" maxlength="10" class="form-control" name="markerscan" value="{{ old('markerscan') ?: $reward->marker_scan }}" required>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-8 col-md-9">
            <input id="serialCode" type="text" maxlength="10" class="form-control" name="serialCode" value="{{ old('serialCode') ?: $reward->serial_code }}" required>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-8 col-md-9">
            <select id="status" class="form-control" name="status" required>
              <option value="1" @if (old('active') == '1' || $reward->active == '1') selected="selected" @endif>Active</option>
              <option value="0" @if (old('active') == '0' || $reward->active == '0') selected="selected" @endif>Inactive</option>
            </select>
