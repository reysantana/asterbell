    ...
    <div class="col-sm-10 offset-sm-1 col-md-8 offset-md-2">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Create AR Game</li>
        </ol>
      </nav>
      ...
      <div class="card">
        ...
        @endif
          ...
          <form class="needs-validation" novalidate enctype="multipart/form-data" method="POST" action="{{ url('/argames') }}">
            {{ csrf_field() }}
            ...
            <div class="form-group row">
              <label for="start-score" class="col-sm-4 col-md-3 col-form-label">Score Submit Open Time</label>

              <div class="col-sm-8 col-md-9">
                <input id="start-score"  type="time" class="form-control datetimepicker-input" name="startScore">
              </div>
            </div>

            <div class="form-group row">
              <label for="end-score" class="col-sm-4 col-md-3 col-form-label">Score Submit Close Time</label>

              <div class="col-sm-8 col-md-9">
                <input id="end-score"  type="time" class="form-control datetimepicker-input" name="endScore">
              </div>
            </div>
...
<!--             <div class="form-group row">
              <label for="score" class="col-sm-4 col-md-3 col-form-label">Prize Score</label>

              <div class="col-sm-8 col-md-9">
                <input id="score" type="text" maxlength="255" class="form-control" name="score" value="{{ old('score') }}" required>
...
$(document).ready(() => {
  ...
  // $('#start-score').datetimepicker({
  //   format: 'HH:mm:ss',
  //   date: '{{ old("startScore") }}'
  // });

  // $('#end-score').datetimepicker({
  //   format: 'HH:mm:ss',
  //   date: '{{ old("endScore") }}'
  // });
