    ...
    <div class="col-sm-10 offset-sm-1 col-md-8 offset-md-2">
      ...
      <div class="card">
        ...
        @endif
          ...
          <form class="needs-validation" novalidate method="POST" action="{{ url('/vouchers/update/'.$voucher->id.'') }}">
            {{ csrf_field() }}
            {{ method_field('POST') }}
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-8 col-md-9">
                <input id="name" type="text" maxlength="255" class="form-control" name="name" value="{{ old('name') ?: $voucher->name }}" required>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-8 col-md-9">
                <textarea class="form-control" name="description" rows="5">{{ old('description') ?: $voucher->description  }}</textarea>
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-8 col-md-9">
                <textarea class="form-control" name="tnc" rows="5">{{ old('tnc') ?: $voucher->tnc  }}</textarea>
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-8 col-md-9">
                <select id="status" class="form-control" name="status" required>
                  <option value="1" @if (old('active') == '1' || $voucher->active == '1') selected="selected" @endif>Active</option>
                  <option value="0" @if (old('active') == '0' || $voucher->active == '0') selected="selected" @endif>Inactive</option>
                </select>
            ...
            <div class="form-group row">
              <label for="available" class="col-sm-4 col-md-3 col-form-label">Available</label>

              <div class="col-sm-8 col-md-9">
                <input id="available" type="text" maxlength="255" class="form-control" name="available" value="{{ old('available') ?: $voucher->available  }}" required>
                <div class="invalid-feedback">Please fill in the available</div>
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-8 col-md-9">
                <input id="limit" type="text" maxlength="255" class="form-control" name="limit" value="{{ old('limit') ?: $voucher->limit  }}" required>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-8 col-md-9">
                ...
                @if ($voucher && $voucher->image_path)
                <div class="image-preview">
                  <img src="{{ asset($voucher->image_path) }}" />
                </div>
                @endif
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-8 col-md-9">
                ...
                @if ($voucher && $voucher->thumbnail_path)
                <div class="image-preview">
                  <img src="{{ asset($voucher->thumbnail_path) }}" />
                </div>
                @endif
              </div>
            </div>
...
$(document).ready(() => {
  $('#start-date').datetimepicker({
    ...
    date: '{{ old("startDate") ?: $voucher->start_date }}'
  });

  $('#end-date').datetimepicker({
    format: 'YYYY-MM-DD HH:mm:ss',
    date: '{{ old("endDate") ?: $voucher->end_date }}'
  });
